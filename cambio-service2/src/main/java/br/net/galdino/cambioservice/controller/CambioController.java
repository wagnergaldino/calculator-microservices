package br.net.galdino.cambioservice.controller;
...
import br.net.galdino.cambioservice.repository.CambioRepository;
...
public class CambioController {
	...
	@Operation(summary = "Convert amount from a currency to another")
